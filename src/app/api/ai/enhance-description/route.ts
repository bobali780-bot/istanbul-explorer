...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`🤖 GPT Enhancement: Creating premium description for "${title}"`);
...
**Format:** Return only the description text, no additional formatting or quotes.`;
    ...
    console.log(`✅ GPT Enhancement: Generated ${enhancedDescription.length} characters for "${title}"`);
